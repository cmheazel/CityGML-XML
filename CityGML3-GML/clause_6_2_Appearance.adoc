...
The CityGML Appearance XML element names are shown with a XML namespace prefix of “TBD”. Corresponding CityGML UML classes are shown with their CityGML Requirements Class prefix of “TBD”.
