:Title: OGC CityGML 3.0 XML: Part 0 - Core - Encoding Standard
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/CityGML-XML-0/3.0
...
include::clause_6_first_conformance_class.adoc[]

include::clause_7_second_conformance_class.adoc[]

include::clause_8_third_conformance_class.adoc[]

include::clause_9_forth_conformance_class.adoc[]
